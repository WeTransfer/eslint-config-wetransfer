[![Build Status](https://travis-ci.com/WeTransfer/eslint-config-wetransfer.svg?token=BrByTtLgfVKqDJ6GzD2p&branch=master)](https://travis-ci.com/WeTransfer/eslint-config-wetransfer)
